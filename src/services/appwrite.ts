...
// Expo only embeds EXPO_PUBLIC_* values in a release bundle when each variable
// is referenced with dot notation. Do not replace this map with process.env[key]:
// that works in Metro/dev but leaves the values undefined in an EAS preview build.
const env = {
  ...
  EXPO_PUBLIC_APPWRITE_REVIEW_LIKES_COLLECTION_ID:
    process.env.EXPO_PUBLIC_APPWRITE_REVIEW_LIKES_COLLECTION_ID,
  EXPO_PUBLIC_APPWRITE_REVIEW_COMMENTS_COLLECTION_ID:
    process.env.EXPO_PUBLIC_APPWRITE_REVIEW_COMMENTS_COLLECTION_ID,
  ...
  EXPO_PUBLIC_APPWRITE_REVIEW_REPORTS_COLLECTION_ID:
    process.env.EXPO_PUBLIC_APPWRITE_REVIEW_REPORTS_COLLECTION_ID,
  EXPO_PUBLIC_APPWRITE_FOLLOWS_COLLECTION_ID:
    process.env.EXPO_PUBLIC_APPWRITE_FOLLOWS_COLLECTION_ID,
  EXPO_PUBLIC_APPWRITE_BLOCKS_COLLECTION_ID:
    process.env.EXPO_PUBLIC_APPWRITE_BLOCKS_COLLECTION_ID,
  ...
  EXPO_PUBLIC_APPWRITE_MEDIA_BUCKET_ID:
    process.env.EXPO_PUBLIC_APPWRITE_MEDIA_BUCKET_ID,
  EXPO_PUBLIC_APPWRITE_ADMIN_TEAM_ID:
    process.env.EXPO_PUBLIC_APPWRITE_ADMIN_TEAM_ID,
  EXPO_PUBLIC_APPWRITE_APP_CONFIG_COLLECTION_ID:
    process.env.EXPO_PUBLIC_APPWRITE_APP_CONFIG_COLLECTION_ID,
  EXPO_PUBLIC_APPWRITE_RESTAURANT_VIEWS_COLLECTION_ID:
    process.env.EXPO_PUBLIC_APPWRITE_RESTAURANT_VIEWS_COLLECTION_ID,
  EXPO_PUBLIC_APPWRITE_RESTAURANT_CLAIMS_COLLECTION_ID:
    process.env.EXPO_PUBLIC_APPWRITE_RESTAURANT_CLAIMS_COLLECTION_ID,
  EXPO_PUBLIC_APPWRITE_REVIEW_RESPONSES_COLLECTION_ID:
    process.env.EXPO_PUBLIC_APPWRITE_REVIEW_RESPONSES_COLLECTION_ID,
  ...
  EXPO_PUBLIC_APPWRITE_BUG_REPORTS_COLLECTION_ID:
    process.env.EXPO_PUBLIC_APPWRITE_BUG_REPORTS_COLLECTION_ID,
  EXPO_PUBLIC_APPWRITE_RESTAURANT_MENUS_COLLECTION_ID:
    process.env.EXPO_PUBLIC_APPWRITE_RESTAURANT_MENUS_COLLECTION_ID,
  EXPO_PUBLIC_APPWRITE_ACONTROL_COLLECTION_ID:
    process.env.EXPO_PUBLIC_APPWRITE_ACONTROL_COLLECTION_ID,
  EXPO_PUBLIC_APPWRITE_COMMENT_REPORTS_COLLECTION_ID:
    process.env.EXPO_PUBLIC_APPWRITE_COMMENT_REPORTS_COLLECTION_ID,
  EXPO_PUBLIC_APPWRITE_POSTS_COLLECTION_ID:
    process.env.EXPO_PUBLIC_APPWRITE_POSTS_COLLECTION_ID,
  EXPO_PUBLIC_APPWRITE_POST_LIKES_COLLECTION_ID:
    process.env.EXPO_PUBLIC_APPWRITE_POST_LIKES_COLLECTION_ID,
  EXPO_PUBLIC_APPWRITE_POST_COMMENTS_COLLECTION_ID:
    process.env.EXPO_PUBLIC_APPWRITE_POST_COMMENTS_COLLECTION_ID,
  EXPO_PUBLIC_APPWRITE_POST_REPORTS_COLLECTION_ID:
    process.env.EXPO_PUBLIC_APPWRITE_POST_REPORTS_COLLECTION_ID,
  EXPO_PUBLIC_APPWRITE_POST_COMMENT_REPORTS_COLLECTION_ID:
    process.env.EXPO_PUBLIC_APPWRITE_POST_COMMENT_REPORTS_COLLECTION_ID,
  EXPO_PUBLIC_APPWRITE_SEND_NOTIFICATION_FUNCTION_ID:
    process.env.EXPO_PUBLIC_APPWRITE_SEND_NOTIFICATION_FUNCTION_ID,
...
function optionalEnv(key: keyof typeof env, fallback: string = ""): string {
